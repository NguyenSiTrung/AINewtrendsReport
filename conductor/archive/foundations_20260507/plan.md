...
- [x] Task 1: Initialize `pyproject.toml` with uv
...
- [x] Task 2: Configure linting, formatting, and type checking
...
- [x] Task 1: Create source directory tree
...
- [x] Task 2: Create deployment skeleton
  <!-- files: deploy/systemd/, deploy/cron/, deploy/nginx/, deploy/install.sh, alembic/ -->

- [x] Task 3: Create local dev data directory
...
- [x] Task 1: Implement pydantic-settings config (TDD)
...
- [x] Task 1: Implement structlog configuration (TDD)
...
- [x] Task 1: Implement Typer CLI app (TDD)
...
- [x] Task 1: Full integration verification
...
- [x] Task: Conductor - User Manual Verification 'Phase 6: Verification & Exit Criteria' (Protocol in workflow.md)
