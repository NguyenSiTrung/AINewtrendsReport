...
- [x] Task 1: Add Phase 2 runtime & dev dependencies
...
- [x] Task 2: LLMConfig pydantic model
...
- [x] Task 3: Config resolution — `get_llm_config()`
...
- [x] Task 5: Connection test — `test_llm_connection()`
...
- [x] Task 6: CLI `ainews llm test` command
...
- [x] Task: Conductor - User Manual Verification 'LLM Client Foundation' (Protocol in workflow.md)
...
- [x] Task 1: SearchResult model & CacheBackend protocol
...
- [x] Task 2: InMemoryCache implementation
...
- [x] Task 3: TavilySearchTool wrapper
...
- [x] Task: Conductor - User Manual Verification 'Tavily Search Wrapper' (Protocol in workflow.md)
...
- [x] Task: Conductor - User Manual Verification 'Web Scraper' (Protocol in workflow.md)
...
- [x] Task 2: Simhash implementation
...
- [x] Task 3: Jaccard shingle similarity
...
- [x] Task 4: Cluster & deduplicate orchestrator
...
- [x] Task: Conductor - User Manual Verification 'Deduplication Engine' (Protocol in workflow.md)
